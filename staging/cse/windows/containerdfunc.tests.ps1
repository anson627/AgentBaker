...
Describe 'Install-Containerd-Based-On-Kubernetes-Version' {
  ...
  It 'k8s version is less than MinimalKubernetesVersionWithLatestContainerd' {
    ...
    & Install-Containerd-Based-On-Kubernetes-Version -ContainerdUrl "https://acs-mirror.azureedge.net/containerd/windows/{0}/binaries/containerd-{0}-windows-amd64.tar.gz" -KubernetesVersion "1.25.0" -CNIBinDir "cniBinPath" -CNIConfDir "cniConfigPath" -KubeDir "kubeDir"
  ...
  It 'k8s version is equal to MinimalKubernetesVersionWithLatestContainerd' {
    ...
    & Install-Containerd-Based-On-Kubernetes-Version -ContainerdUrl "https://acs-mirror.azureedge.net/containerd/windows/{0}/binaries/containerd-{0}-windows-amd64.tar.gz" -KubernetesVersion "1.26.0" -CNIBinDir "cniBinPath" -CNIConfDir "cniConfigPath" -KubeDir "kubeDir"
    Assert-MockCalled -CommandName "Install-Containerd" -Exactly -Times 1 -ParameterFilter { $ContainerdUrl -eq $expectedURL }
  }

  It 'k8s version is greater than MinimalKubernetesVersionWithLatestContainerd' {
    $expectedURL = [string]::Format("https://acs-mirror.azureedge.net/containerd/windows/{0}/binaries/containerd-{0}-windows-amd64.tar.gz", $global:LatestContainerdVersion)
    & Install-Containerd-Based-On-Kubernetes-Version -ContainerdUrl "https://acs-mirror.azureedge.net/containerd/windows/{0}/binaries/containerd-{0}-windows-amd64.tar.gz" -KubernetesVersion "1.26.1" -CNIBinDir "cniBinPath" -CNIConfDir "cniConfigPath" -KubeDir "kubeDir"
    Assert-MockCalled -CommandName "Install-Containerd" -Exactly -Times 1 -ParameterFilter { $ContainerdUrl -eq $expectedURL }
  }
